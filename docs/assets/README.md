...
| --- | --- | --- |
| `dnp-gui-overview.png` | Main README GUI preview | Capture the GUI after selecting `data/synthetic_correction_input.xlsx`, with `SpecNorm+PQN` selected and Auto Run ready. |
