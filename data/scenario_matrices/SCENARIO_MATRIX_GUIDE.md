...
| `mixed_direction_batch_drift` | `mixed_direction_batch_drift.xlsx` | Step 2 / Step 3 | QC trajectories should slope upward in one batch and downward in another.; Step 3 should still produce batch-alignment diagnostics after Step 2. |
